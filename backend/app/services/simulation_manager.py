...
from .graphiti_entity_reader import ZepEntityReader, FilteredEntities
    ...
    def prepare_simulation(
        ...
        try:
            ...
            if filtered.filtered_count == 0:
                ...
                state.error = "No matching entities found, please check if graph is correctly built"
                self._save_simulation_state(state)
                return state
            ...
            # Note: Runtime scripts remain in backend/scripts/ directory, no longer copied to simulation directory
