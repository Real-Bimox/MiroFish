...
from .graphiti_memory_updater import GraphitiMemoryManager as ZepGraphMemoryManager
...
class SimulationRunState:
    ...
    # Platform-independent rounds and simulation time (for dual-platform parallel display)
    ...
    def to_dict(self) -> Dict[str, Any]:
        return {
            ...
            # Platform-independent rounds and time
...
class SimulationRunner:
    ...
    2. Parse runtime logs, record each Agent's actions
    ...
    def start_simulation(
        ...
        # If enabling graph memory update, create updater
        ...
        try:
            ...
            # Use start_new_session=True to create new process group, ensure all child processes can be terminated via os.killpg
                        ...
                        try:
                            ...
                            if "event_type" in action_data:
                                ...
                                if event_type == "simulation_end":
                                    ...
                                    # If two platforms running, need both to complete
                                ...
                                # Update round info (from round_end event)
                                    ...
                                    # Update platform-independent rounds and time
                                    if platform == "twitter":
    ...
    def _check_all_platforms_completed(cls, state: SimulationRunState) -> bool:
        ...
        Determine if a platform is enabled by checking if its corresponding actions.jsonl file exists
    ...
    def get_all_actions(
        ...
        # If platform-separated files don't exist, try reading old single file format
        if not actions:
    ...
    def cleanup_all_simulations(cls):
        ...
        # Check if there's content to clean up (avoid printing useless logs for empty processes)
    ...
    def register_cleanup(cls):
        ...
        Called when Flask app starts to ensure all simulation processes are cleaned up when server shuts down
        """
    ...
    def interview_agent(
        ...
        Args:
            ...
            platform: Specify platform (optional)
                ...
                - None: When dual-platform simulation, interview both platforms simultaneously, return integrated result
