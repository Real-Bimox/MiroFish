...
class OasisProfileGenerator:
    ...
    Converts entities from Zep graph to Agent Profiles required by OASIS simulation
    ...
    3. Distinguish between individual entities and group/institution entities
    """
    ...
    def _build_entity_context(self, entity: EntityNode) -> str:
        ...
        # 4. Use graph search to get richer information
        graph_context = self._enrich_entity_with_graph_context(entity.name)
        if graph_context:
    ...
    def _generate_profile_with_llm(
        ...
        # Try multiple generations until success or max retry attempts reached
        max_attempts = 3
        last_error = None
    ...
    def _try_fix_json(self, content: str, entity_name: str, entity_type: str, entity_summary: str = "") -> Dict[str, Any]:
        ...
        if json_match:
            ...
            try:
                ...
                # 5. If still fails, try more aggressive fixes
                try:
    ...
    def _get_system_prompt(self, is_individual: bool) -> str:
        """Get system prompt"""
        base_prompt = "You are a social media user profile generation expert. Generate detailed, realistic personas for public opinion simulation, maximizing the restoration of existing reality. Must return valid JSON format, all string values cannot contain unescaped newlines. Use Chinese."
        return base_prompt
    ...
    def _build_individual_persona_prompt(
        ...
        return f"""Generate detailed social media user persona for the entity, maximizing the restoration of existing reality.
...
2. persona: Detailed persona description (2000 characters of plain text), should include:
   ...
   - Positions and views (attitudes towards topics, what might trigger/ move them)
...
"""
    ...
    def _build_group_persona_prompt(
        ...
        return f"""Generate detailed social media account settings for institution/group entities, maximizing the restoration of existing reality.
...
2. persona: Detailed account settings description (2000 characters of plain text), should include:
   ...
   - Institution memory (important part of institution persona, describe this institution's connection to events and its existing actions and reactions)
3. age: Fixed at 30 (virtual age for institution accounts)
4. gender: Fixed at "other" (institution accounts use other to indicate non-individual)
