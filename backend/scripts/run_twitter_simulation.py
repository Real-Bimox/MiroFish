...
This script reads configuration parameters to execute simulation, achieving full automation
...
def setup_oasis_logging(log_dir: str):
    """Configure OASIS logging using fixed filename log files"""
...
class TwitterSimulationRunner:
    ...
    async def run(self, max_rounds: int = None):
        ...
        print(f"  - Total simulation hours: {total_hours}")
...
async def main():
    ...
    # Initialize logging configuration (use fixed filename, clean old logs)
...
def setup_signal_handlers():
    ...
    Allow program to clean up resources properly (close database, environment, etc.)
    """
