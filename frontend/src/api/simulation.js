 ...
 * @param {string} simulationId
 * @returns {Promise} ConfigurationInfo, contains metadata and Configuration content
 */
...
/**
 * Get simulation running detailed status (includes recent actions)
 * @param {string} simulationId
 */
