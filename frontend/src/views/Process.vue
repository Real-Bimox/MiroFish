  ...
  <div class="process-page">
    ...
    <nav class="navbar">
      ...
      <div class="nav-center">
        <div class="step-badge">{{ $t('step1.stepNum') }}</div>
        <div class="step-name">{{ $t('step1.title') }}</div>
      </div>
      ...
      <div class="left-panel" :class="{ 'full-screen': isFullScreen }">
        <div class="panel-header">
          <div class="header-left">
            ...
            <span class="header-title">{{ $t('step1.knowledgeGraphView') }}</span>
          </div>
          <div class="header-right">
            <template v-if="graphData">
              <span class="stat-item">{{ graphData.node_count || graphData.nodes?.length || 0 }} {{ $t('step1.nodes') }}</span>
              <span class="stat-divider">|</span>
              <span class="stat-item">{{ graphData.edge_count || graphData.edges?.length || 0 }} {{ $t('step1.relationships') }}</span>
              <span class="stat-divider">|</span>
            </template>
            <div class="action-buttons">
                <button class="action-btn" @click="refreshGraph" :disabled="graphLoading" :title="$t('step1.refreshGraph')">
                  <span class="icon-refresh" :class="{ 'spinning': graphLoading }">↻</span>
                </button>
                <button class="action-btn" @click="toggleFullScreen" :title="isFullScreen ? $t('step1.exitFullscreen') : $t('step1.fullscreen')">
        ...
        <div class="graph-container" ref="graphContainer">
          ...
          <div v-if="graphData" class="graph-view">
            ...
            <div v-if="currentPhase === 1" class="graph-building-hint">
              ...
              {{ $t('step1.updatingRealtime') }}
            </div>
            
            <!-- Nodes/Edge Details panel -->
            <div v-if="selectedItem" class="detail-panel">
              <div class="detail-panel-header">
                <span class="detail-title">{{ selectedItem.type === 'node' ? $t('step1.nodeDetails') : $t('step1.edgeDetails') }}</span>
              ...
              <div v-else class="detail-content">
                ...
                <div class="detail-subtitle">{{ $t('step1.edgeDetails') }}</div>
                ...
                <div class="detail-row">
                  <span class="detail-label">{{ $t('step1.label') }}:</span>
                ...
                <div class="detail-row" v-if="selectedItem.data.expired_at">
                  <span class="detail-label">{{ $t('step1.expiredAt') }}:</span>
          ...
          <div v-else-if="graphLoading" class="graph-loading">
            ...
            <p class="loading-text">{{ $t('step1.graphLoading') }}</p>
          </div>
          ...
          <div v-else-if="currentPhase < 1" class="graph-waiting">
            ...
            <p class="waiting-text">{{ $t('step1.waitingOntology') }}</p>
          ...
          <div class="process-phase" :class="{ 'active': currentPhase === 0, 'completed': currentPhase > 0 }">
            ...
            <div class="phase-detail">
              ...
              <div class="detail-section waiting-state" v-if="!projectData?.ontology && currentPhase === 0 && !ontologyProgress">
                <div class="waiting-hint">{{ $t('step1.waitingOntology') }}...</div>
              </div>
            </div>
          </div>
        ...
        <div class="project-panel">
          ...
          <div class="project-details" v-if="projectData">
            <div class="project-item">
              <span class="item-label">{{ $t('step1.projectName') }}</span>
              <span class="item-value">{{ projectData.name }}</span>
            </div>
            <div class="project-item">
              <span class="item-label">{{ $t('step1.projectId') }}</span>
            ...
            <div class="project-item">
              <span class="item-label">{{ $t('step1.simulationRequirement') }}</span>
...
const statusText = computed(() => {
  if (error.value) return t('step1.buildFailed') || 'Build Failed'
...
const getPhaseStatusText = (phase) => {
  if (currentPhase.value > phase) return t('step1.ontologyCompleted')
  ...
  return t('step1.ontologyPending')
}
